...
export const vehicles: Vehicle[] = [
  {
    id: "mercedes-benz-gle-2025",
    name: "Mercedes-Benz GLE 53 Coupe 2025",
    year: 2025,
    category: "SUV",
    pricePerDay: 325,
    seats: 5,
    luggage: 3,
    airportReady: true,
    highlight: "AMG-enhanced performance, coupe styling, luxury cabin",
    features: ["AMG performance package", "MBUX Hyperscreen", "Premium leather seats", "Adaptive air suspension", "Burmester 4D surround", "Active cruise control"],
    overview: "The 2025 Mercedes-Benz GLE 53 Coupe blends high-performance AMG power with coupe-inspired design and premium luxury for every Atlanta rental.",
    deposit: "$750 refundable deposit",
    insuranceRequirement: "Full coverage required; premium policy recommended",
    turoURL: "https://turo.com/us/en/car-rental/united-states/atlanta-ga/mercedes-benz/gle-53/"
  },
  {
    id: "chevrolet-corvette-2025",
    name: "Chevrolet Corvette 2023 C8 2LT",
    year: 2023,
  ...
  },
  {
    ...
    name: "Mercedes-Benz GLC 300 Coupe 2025",
    year: 2025,
    category: "SUV",
    pricePerDay: 200,
    seats: 5,
